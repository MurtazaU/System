												...
												<div class="form-group">
													...
													<select name="country" required class="selectpicker show-tick form-control" data-live-search="true">
														...
														try {
															...
															foreach ($result as $row) {
														?> <option <?php if ($jobcountry == $row['country_name']) {
																		print ' selected ';
												...
												<div class="form-group">
													...
													<select name="category" required class="selectpicker show-tick form-control" data-live-search="true">
														...
														try {
															...
															foreach ($result as $row) {
														?> <option <?php if ($jobcategory == $row['category']) {
																		print ' selected ';
																	} ?> value="<?php echo $row['category']; ?>"><?php echo $row['category']; ?></option> <?php
												...
												<div class="form-group mb-20">
													...
													<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
														...
														<option <?php if ($jobtype == "Full-time") {
																	print ' selected ';
																} ?> value="Full-time" data-content="<span class='label label-warning'>Full-time</span>">Full-time</option>
														<option <?php if ($jobtype == "Part-time") {
																	print ' selected ';
																} ?> value="Part-time" data-content="<span class='label label-danger'>Part-time</span>">Part-time</option>
														<option <?php if ($jobtype == "Freelance") {
																	print ' selected ';
																} ?> value="Freelance" data-content="<span class='label label-success'>Freelance</span>">Freelance</option>
													</select>
												</div>
											...
											<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
												...
												<div class="form-group mb-20">
													...
													<select name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
														<option value="" selected>Select</option>
														<option <?php if ($experience == "Expert") {
																	print ' selected ';
																} ?> value="Expert">Expert</option>
														<option <?php if ($experience == "2 Years") {
																	print ' selected ';
																} ?> value="2 Years">2 Years</option>
														<option <?php if ($experience == "3 Years") {
																	print ' selected ';
																} ?> value="3 Years">3 Years</option>
														<option <?php if ($experience == "4 Years") {
																	print ' selected ';
																} ?> value="4 Years">4 Years</option>
														<option <?php if ($experience == "5 Years") {
																	print ' selected ';
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-12 col-md-3 mt-30-sm">
							...
							<h5 class="footer-title">JustEntryLevel </h5>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-4">
							...
							<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> JustEntryLevel</p>
