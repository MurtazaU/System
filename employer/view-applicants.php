...
<head>
	...
	<title>JustEntryLevel Jobs - Applicants for the job <?php echo "$job_title"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="./">Home</a></li>
						<li><span>Applicants for the job <?php echo "$job_title"; ?></< /span>
						</li>
					</ol>
						...
						<ul class="pager-list">
							...
							if ($records > 1) {
								...
								if ($page == "1") {
									...
									print 'href="view-applicants.php?jobid=' . $job_id . '&page=' . $prevpage . '"';
								}
							...
							?><li class="paging-nav"><a <?php if ($b == $page) {
															print ' style="background-color:#33B6CB; color:white" ';
														} ?> href="view-applicants.php?jobid=<?php echo "$job_id"; ?>&page=<?php echo "$b"; ?>"><?php echo $b . " "; ?></a></li><?php
																																											}
																																											print '<li class="paging-nav"';
																																											if ($page == $records) {
																																												print 'class="disabled"';
																																											...
																																											if ($page == $records) {
																																												...
																																												print 'href="view-applicants.php?jobid=' . $job_id . '&page=' . $nextpage . '"';
																																											}
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Phone : <a href="tel:+233546607474">+</a></p>
