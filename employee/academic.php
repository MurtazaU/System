																			...
																			<div class="col-sm-12 col-md-12">
																				...
																				<div class="form-group">
																					...
																					<select name="level" required class="selectpicker show-tick form-control" data-live-search="false">
																						...
																						<option <?php if ($level == "Advanced Diploma") {
																									print ' selected ';
																								} ?> value="Advanced Diploma">Advanced Diploma</option>
																						<option <?php if ($level == "Advanced Level (ACSE)") {
																									print ' selected ';
																								} ?> value="Advanced Level (ACSE)">Advanced Level (ACSE)</option>
																						<option <?php if ($level == "Certificate") {
																									print ' selected ';
																								} ?> value="Certificate">Certificate</option>
																						<option <?php if ($level == "Degree") {
																									print ' selected ';
																								} ?> value="Degree">Degree</option>
																						<option <?php if ($level == "Diploma") {
																									print ' selected ';
																								} ?> value="Diploma">Diploma</option>
																						<option <?php if ($level == "Master Degree") {
																									print ' selected ';
																								} ?> value="Master Degree">Master Degree</option>
																						<option <?php if ($level == "Ordinary Level (CSE)") {
																									print ' selected ';
																								} ?> value="Ordinary Level (CSE)">Ordinary Level (CSE)</option>
																						<option <?php if ($level == "PHd") {
																									print ' selected ';
																								} ?> value="PHd">PHd</option>
																						<option <?php if ($level == "Post Graduate Diploma") {
																									print ' selected ';
																								} ?> value="Post Graduate Diploma">Post Graduate Diploma</option>
																			...
																			<div class="col-sm-12 col-md-6">
																				...
																				<div class="form-group">
																					...
																					<select name="country" required class="selectpicker show-tick form-control" data-live-search="true">
																						...
																						?>
																							<option <?php if ($ccountry == $rowb['country_name']) {
																										print ' selected ';
										...
										<ul class="pager-list">
											...
											if ($records > 1) {
												...
												if ($page == "1") {
													...
													print 'href="academic.php?page=' . $prevpage . '"';
												}
											...
											?><li class="paging-nav"><a <?php if ($b == $page) {
																print ' style="background-color:#33B6CB; color:white" ';
															} ?> href="academic.php?page=<?php echo "$b"; ?>"><?php echo $b . " "; ?></a></li><?php
																																																							}
																																																							print '<li class="paging-nav"';
																																																							if ($page == $records) {
																																																								print 'class="disabled"';
																																																							...
																																																							if ($page == $records) {
																																																								...
																																																								print 'href="academic.php?page=' . $nextpage . '"';
																																																							}
