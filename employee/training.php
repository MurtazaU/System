												...
												<div class="row">
													...
													<div class="col-sm-12 col-md-10">
														...
														<div class="content">
															...
															<a <?php if ($certificate == "") {
																} else { ?> target="_blank" href="view-certificate-b.php?id=<?php echo $row['id']; ?> <?php } ?>">
										...
										<ul class="pager-list">
											...
											if ($records > 1) {
												...
												if ($page == "1") {
													...
													print 'href="training.php?page=' . $prevpage . '"';
												}
											...
											?><li class="paging-nav"><a <?php if ($b == $page) {
																print ' style="background-color:#33B6CB; color:white" ';
															} ?> href="training.php?page=<?php echo "$b"; ?>"><?php echo $b . " "; ?></a></li><?php
																																																							}
																																																							print '<li class="paging-nav"';
																																																							if ($page == $records) {
																																																								print 'class="disabled"';
																																																							...
																																																							if ($page == $records) {
																																																								...
																																																								print 'href="training.php?page=' . $nextpage . '"';
																																																							}
