																				...
																				<div class="form-group">
																					...
																					<select name="country" required class="selectpicker show-tick form-control" data-live-search="true">
																						...
																						?>
																								...
																								<option <?php if ($ccountry == $row['country_name']) {
																											print ' selected ';
										...
										<ul class="pager-list">
											...
											if ($records > 1) {
												...
												if ($page == "1") {
													...
													print 'href="qualifications.php?page=' . $prevpage . '"';
												}
											...
											?><li class="paging-nav"><a <?php if ($b == $page) {
																print ' style="background-color:#33B6CB; color:white" ';
															} ?> href="qualifications.php?page=<?php echo "$b"; ?>"><?php echo $b . " "; ?></a></li><?php
																																																								}
																																																								print '<li class="paging-nav"';
																																																								if ($page == $records) {
																																																									print 'class="disabled"';
																																																								...
																																																								if ($page == $records) {
																																																									...
																																																									print 'href="qualifications.php?page=' . $nextpage . '"';
																																																								}
